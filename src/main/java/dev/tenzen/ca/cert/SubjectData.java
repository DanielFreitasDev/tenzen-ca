...
public record SubjectData(
    ...
    public static final class Builder {
        ...
        public Builder nis(String v) {
            this.nis = v;
            return this;
        }

        public Builder rg(String v) {
            this.rg = v;
            return this;
        }

        public Builder rgIssuerUf(String v) {
            this.rgIssuerUf = v;
            return this;
        }

        public Builder voterId(String v) {
            this.voterId = v;
            return this;
        }

        public Builder voterZone(String v) {
            this.voterZone = v;
            return this;
        }

        public Builder voterSection(String v) {
            this.voterSection = v;
            return this;
        }

        public Builder ceiNit(String v) {
            this.ceiNit = v;
            return this;
        }

        public Builder razaoSocial(String v) {
            this.razaoSocial = v;
            return this;
        }

        public Builder cnpj(String v) {
            this.cnpj = v;
            return this;
        }

        public Builder companyCei(String v) {
            this.companyCei = v;
            return this;
        }

        public Builder responsibleName(String v) {
            this.responsibleName = v;
            return this;
        }

        public Builder responsibleCpf(String v) {
            this.responsibleCpf = v;
            return this;
        }

        public Builder responsibleBirthDate(LocalDate v) {
            this.responsibleBirthDate = v;
            return this;
        }

        public Builder responsibleNis(String v) {
            this.responsibleNis = v;
            return this;
        }

        public Builder responsibleRg(String v) {
            this.responsibleRg = v;
            return this;
        }

        public Builder responsibleRgIssuerUf(String v) {
            this.responsibleRgIssuerUf = v;
            return this;
        }
        ...
        public Builder validationType(String v) {
